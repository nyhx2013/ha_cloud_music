class HaPanelBaiduMap extends HTMLElement {
  ...
  addOverlay({latitude, longitude, pic}, type, click){
      ...
      //创建家庭图标
      var myIcon = new BMap.Icon(pic, new BMap.Size(48,48));
  ...
  update(){
      ...
      keys.forEach(key => {
          ...
          if('longitude' in attr && 'latitude' in attr){
              ...
              this.translate({longitude: attr.longitude, latitude: attr.latitude}).then(res=>{
                  let point = res[0]
  ...
  actionPanel(){
      ...
      ZoomControl.prototype.initialize = function(map){
        ...
        select.onchange=function(){
            // 这里重新定位
            console.log(this)
            // map.centerAndZoom(new BMap.Point(135, 34), 10);
        }
        // 添加文字说明
